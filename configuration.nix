...
{
  # --- Module Imports ---
  # This is the core of the modular design. Each file imported here is responsible
  # for a specific part of the system's configuration.
  imports = [
    # Hardware-specific configuration generated for this machine.
    ./hardware-configuration.nix

    # Custom configuration module for networking.
    # We will modularize this later. For now, it remains as is.
    ./networking.nix
