{...}: {
  flake.homeModules."dev-lang-web" = {pkgs, ...}: {
    ...
    programs.helix.languages.language-server.vscode-json-language-server = {
      command = "vscode-json-language-server";
      args = ["--stdio"];
    };
    programs.helix.languages.language-server.vscode-html-language-server = {
      command = "vscode-html-language-server";
      args = ["--stdio"];
    };
    programs.helix.languages.language-server.vscode-css-language-server = {
      command = "vscode-css-language-server";
      args = ["--stdio"];
    };
    programs.helix.languages.language-server.svelteserver = {
